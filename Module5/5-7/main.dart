...
import 'package:serviceex/payment.dart';
...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) {
    ...
    var android1 = new AndroidInitializationSettings('@mipmap/ic_launcher');
    //var IOS = new IOSInitializationSettings();

    // initialise settings for both Android and iOS device.
    var settings = new InitializationSettings(android: android1);
