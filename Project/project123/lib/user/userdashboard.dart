...
class UserDashboardScreen2 extends State<UserDashboardScreen> {
  ...
  {
    final responce = await http.get(Uri.parse("https://topstech8.000webhostapp.com/Morning_Batch/API/category_view.php"));
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold
      (
      appBar: AppBar(backgroundColor: Colors.grey,title:Text("Welcome"),actions:
      [
