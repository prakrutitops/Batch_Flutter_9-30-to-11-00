...
class Category extends StatefulWidget {
  var index;
  var category_name;
  Category({Key? key, @required this.index, @required this.category_name})
      : super(key: key);
...
class CategoryPage extends State<Category> {
  ...
  Future<List> viewCategoryItemsData() async {
    final responce = await http.get(Uri.parse(
        "https://topstech8.000webhostapp.com/Ewishes/Category_images/category_images_view.php?data=" +
